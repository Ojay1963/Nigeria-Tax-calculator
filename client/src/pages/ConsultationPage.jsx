...
export default function ConsultationPage() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      setStatus({
        type: "success",
        message: "Consultation request submitted. You can now follow up from the dashboard or admin workflow."
      });
    } catch (error) {
    ...
    <div className="page-stack">
      ...
      <section className="content-card auth-layout">
        ...
        <form className="form-grid" onSubmit={handleSubmit}>
          ...
          <button className="button-primary" type="submit" disabled={submitting}>{submitting ? "Submitting..." : "Request consultation"}</button>
